...
//        . '<br> as requests that have been made for new data. Enjoy our product!</h3></center></div>';
        ?>
    <center>
        <!--        <div id="cnt" onclick="change(this)">Welcome to our NCAA Information Website</div>-->
        <div id="cnt" onclick="change(this)">Welcome to our NCAA Information Website</div>
        <div id="msg">
            <br><br><br>Welcome to our site.<br>
            This website has multiple types of interesting data and analyses based
            <br>off of all of the teams in the NCAA. You can find the
            <br>different kinds of searches provided in the top menu bar, as well
            <br> as requests that have been made for new data. Enjoy our product!
        </div>
    </center>
    <?php
}
...
<script type ="text/javascript">
    ...
    function change(el) {
        el.innerHTML = " ";
        el.style.width = 330 + "px";
        el.innerHTML = "Welcome to our NCAA Information Website";
        var el2 = document.getElementById("msg");
        el2.style.height = 350 + "px";
        el2.style.color = "#333";
        if (counter % 2 === 0) {
